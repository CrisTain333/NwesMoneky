...
const General = () => {
  ...
  const Api = `https://newsapi.org/v2/everything?q=general&page=${page}&apiKey=4d2b67e68d3541f89cf4311152a33577&pageSize=12`;
  ...
  return (
    <div>
      <h1 className="text-center">General News</h1>
      <div className="main">
        {data.map((e) => {
          return (
            <NewsItem
