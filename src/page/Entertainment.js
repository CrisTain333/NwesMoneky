...
const Entertainment = () => {
  ...
  const Api = `https://newsapi.org/v2/everything?q=entertainment&page=${page}&apiKey=4d2b67e68d3541f89cf4311152a33577&pageSize=16`;
  ...
  return (
    <>
      <h1 className="text-center">Entertainment News</h1>
      <div className="main">
        {data.map((e) => {
          return (
            <NewsItem
